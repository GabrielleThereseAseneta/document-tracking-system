...
<head>
    ...
    <title>RMSys - Create New Special Order</title>
    ...
    >
        ...
        <nav class="flex-1 px-3 py-4 space-y-1"> {{-- Consistent padding --}}
            ...
            <a href="{{ route('specialorder.index') }}" class="sidebar-link block px-4 py-2 text-sm font-medium rounded-md flex items-center transition-colors duration-200
                bg-indigo-700 text-white shadow-md" aria-current="{{ Request::routeIs('specialorder.*') ? 'page' : 'false' }}"> {{-- Added shadow-md for active link --}}
        ...
        <footer class="p-4 border-t border-gray-700 text-xs mt-auto">
            <div class="text-gray-400 dark:text-gray-500">
                <p class="mb-0.5">&copy; {{ date('Y') }} Philippine Statistical Authority (PSA).</p> {{-- Use current year --}}
    ...
    <div class="flex flex-col flex-grow lg:ml-64 bg-gray-50 dark:bg-gray-900">
        <main class="flex-1 flex items-center justify-center p-6 md:p-8 text-gray-800 dark:text-gray-200">
            <div class="w-full max-w-3xl bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl mx-auto">
                <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6">Create New Special Order</h1> {{-- Consistent title styling --}}
                    ...
                    <div class="grid grid-cols-1 gap-6"> {{-- Consistent primary layout --}}
                        <div>
                            ...
                            <input
                                ...
                                id="so_number"
                                name="so_number"
                                value="{{ old('so_number') }}" {{-- Added old() for form re-population --}}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="name"
                                name="name"
                                value="{{ old('name') }}" {{-- Added old() for form re-population --}}
                                placeholder="Name"
                                class="w-full px-5 py-2.5 text-sm rounded-md border dark:border-gray-600 border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
                                required>
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('title_description') }}" {{-- Added old() for form re-population --}}
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6"> {{-- Dates in a two-column grid --}}
                            <div>
                                ...
                                <input
                                    ...
                                    id="date_of_so"
                                    name="date_of_so"
                                    value="{{ old('date_of_so') }}" {{-- Added old() for form re-population --}}
                                    class="w-full px-5 py-2.5 text-sm rounded-md border dark:border-gray-600 border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
                                    required>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="date_received"
                                    name="date_received"
                                    value="{{ old('date_received') }}" {{-- Added old() for form re-population --}}
                                    class="w-full px-5 py-2.5 text-sm rounded-md border dark:border-gray-600 border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
                                    required>
                            </div>
                        </div>
