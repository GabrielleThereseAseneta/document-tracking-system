...
<head>
    ...
    <title>RMSys - Create New Memorandum</title>
    ...
    >
        ...
        <nav class="flex-1 px-3 py-4 space-y-1"> {{-- Consistent padding --}}
            ...
            <a href="{{ route('memorandum.index') }}" class="sidebar-link block px-4 py-2 text-sm font-medium rounded-md flex items-center transition-colors duration-200
                bg-indigo-700 text-white shadow-md" aria-current="{{ Request::routeIs('memorandum.*') ? 'page' : 'false' }}"> {{-- Added shadow-md for active link --}}
    ...
    <div class="flex flex-col flex-grow lg:ml-64 bg-gray-50 dark:bg-gray-900">
        <main class="flex-1 flex items-center justify-center p-6 md:p-8 text-gray-800 dark:text-gray-200">
            <div class="w-full max-w-3xl bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl mx-auto">
                <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6">Create New Memorandum</h1> {{-- Consistent title styling --}}
                ...
                <form method="POST" action="{{ route('memorandum.store') }}">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6"> {{-- Consistent primary layout --}}
                        <div>
                            ...
                            <input
                                ...
                                id="memo_number"
                                name="memo_number"
                                value="{{ old('memo_number') }}"
                                placeholder="Memorandum Number"
